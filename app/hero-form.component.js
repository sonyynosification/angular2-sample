        ...
        execute: function() {
            HeroFormComponent = (function () {
                function HeroFormComponent() {
                    ...
                    this.model2 = new hero_1.Hero(19, 'Sony Storm', this.powers[2], 'Las Havanas');
                    this.submitted = false;
                }
                HeroFormComponent.prototype.onSubmit = function () { this.submitted = true; };
                Object.defineProperty(HeroFormComponent.prototype, "diagnostics", {
                    // TODO: Remove this when we're done
                    get: function () { return JSON.stringify(this.model); },
                    enumerable: true,
                    configurable: true
                });
                HeroFormComponent.prototype.isSubmitted = function () {
